...
const CYCLES: Record<string, TopMatesCycle> = {
  "2026-06-20": {
    ...
    entries: [
      ...
      {
        rank: 4,
        userId: "25ce8b4d-2997-4ecf-b134-a572d5f08af9",
        displayName: "missing-harrier",
        totalEarnings: 1167,
        totalRuns: 3,
        uniqueRoutes: 2,
      },
      {
        rank: 5,
        userId: "fbce1045-de51-4270-82c0-5ed67f1cef19",
        displayName: "topboyasante",
        totalEarnings: 446,
        totalRuns: 1,
        uniqueRoutes: 1,
      },
